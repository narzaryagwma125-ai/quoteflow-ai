...
- `SECRET_KEY`, Gemini, and Stripe values are read from the environment at boot.
...
- Card numbers, CVV, and bank details are **never collected or stored** by this app. Payment happens on Stripe's hosted Checkout page.
...
| Webhook replay/forgery | Stripe signature verification + idempotent event processing |
...
- [ ] Configure real SMTP, Gemini, and Stripe credentials.
