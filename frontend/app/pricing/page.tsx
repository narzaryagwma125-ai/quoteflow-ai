    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-4 leading-7 text-slate-600">Start free and upgrade when your quoting volume grows. All paid plans use secure Stripe checkout.</p>
        </div>
        ...
        <div className="mx-auto mt-10 max-w-3xl rounded-2xl border border-slate-200 bg-white p-6 text-center shadow-sm">
          ...
          <p className="mt-2 text-sm leading-6 text-slate-600">Prices are displayed in INR. Stripe can process eligible international card payments when international payments and the required payment methods are enabled on your Stripe account.</p>
        </div>
      </main>
      <SiteFooter />
    </div>
