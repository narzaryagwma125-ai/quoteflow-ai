...
const faqs = [
  {
    ...
    answer:
      "Yes. Every new account starts with a 5-day free trial that includes 50 quotes, unlimited customers, and AI assistance. When the trial ends you can continue on the Free plan (up to 3 quotes a month) or upgrade to Starter or Business.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "No. Subscriptions are processed by Stripe, and we never store credit card numbers. Your card details go directly to Stripe's PCI-compliant servers.",
  },
  {
          ...
          <section className="space-y-3">
            ...
            <div className="space-y-2 text-sm leading-6 text-slate-700">
              <p>
                ...
                with 50 quotes. After the trial, choose from:
              </p>
              <ul className="list-inside list-disc space-y-1 pl-2">
                <li><span className="font-medium text-slate-900">Free</span> — up to 3 quotes/month.</li>
                <li><span className="font-medium text-slate-900">Starter</span> — up to 50 quotes/month.</li>
                <li><span className="font-medium text-slate-900">Business</span> — unlimited quotes.</li>
              </ul>
              <p>
                Upgrades happen in the Billing tab through secure Stripe checkout. You can upgrade,
