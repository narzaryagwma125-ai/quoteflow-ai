      ...
      <main>
        ...
        <section id="pricing" className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-slate-600">Start free. Upgrade when you need more capacity. Secure checkout is powered by Stripe.</p>
          </div>
          ...
          <p className="mt-5 text-center text-xs text-slate-500">Prices shown in INR. International card payments depend on your Stripe account and enabled payment methods.</p>
        </section>
